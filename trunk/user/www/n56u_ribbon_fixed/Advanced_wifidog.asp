...
$j(document).ready(function() {
	...
	init_itoggle('wifidog_ADBYBY');
	init_itoggle('wifidog_Log');
});
...
function initial(){
	...
	show_menu(5, 20);
	show_footer();
	fill_wifidog_status(wifidog_status());
...
function applyRule(){
	...
	document.form.current_page.value = "/Advanced_wifidog.asp";
	document.form.next_page.value = "";	   
	document.form.submit();
	}
}

function fill_wifidog_status(status_code){
	var stext = "Unknown";
	if (status_code == 0)
		stext = "<#Stopped#>";
	else if (status_code == 1)
		stext = "<#Running#>";
	$("wifidog_status").innerHTML = '<span class="label label-' + (status_code != 0 ? 'success' : 'warning') + '">' + stext + '</span>';
}
...
<div class="wrapper">
	...
	<input type="hidden" name="current_page" value="Advanced_wifidog.asp">
	<input type="hidden" name="next_page" value="">
	<input type="hidden" name="next_host" value="">
	<input type="hidden" name="sid_list" value="WifidogConf;">
	...
	<div id="tabMenu" class="submenuBlock"></div>
	  <div class="alert alert-info" style="margin: 10px;">Wifidog 是一款开源的用来实现无线认证的软件。注意：有可能和 ss 插件的防火墙规则冲突！<br />
	...
	<tr>
	<th>运行状态:</th>
	  <td id="wifidog_status" colspan="3"></td>
	</tr>
	<tr>
	...
	<br /><span style="color:#888;">默认"/"根目录,例如: "/auth/","/wifidog/"</span></td>
	</tr>
	<tr>
	...
	<tr>
	<th style="border: 0 none;">网关与服务器间网络检测频率:</th>
	...
	<br /><span style="color:#888;">默认每隔60秒检测并传输流量计数一次</span></td>
	</tr>
	 <tr>
	<th style="border: 0 none;">认证失效所需检测失败次数:</th>
	...
	<br /><span style="color:#888;">默认客户端连续5次检测不在线，即需重新联网认证</span></td>
	</tr>
	<tr>
	...
	<br /><span style="color:#888;">默认00:00:DE:AD:BE:AF,多个MAC用英文逗号","连接</span></td>
	</tr>
